    ...
    <View style={{flex:1, paddingTop: 20,backgroundColor: myColor}}>
      <View style={{flex: 3.5/10,}}>
        ...
        <View style={{flex:1.25/5, justifyContent: 'center'}}>
          <Text style={{textAlign: 'center', fontSize: 17, fontWeight: '500', color:background}}>Welcome to the AI Quiz Generator App</Text>
        </View>
        <View style={{flex:1.25/5,  flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', marginBottom:5}}>
          <View>
            <Text style={{fontSize: 15, borderRadius:4, padding:4,fontWeight:'700', elevation:10, backgroundColor: background, color: myColor}}>Overall Performance: {(()=>{return (overallPerformance==='None'?0:overallPerformance)})()}%</Text>
          </View> 
        </View>
      </View>
